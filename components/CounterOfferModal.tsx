...
export default function CounterOfferModal({ isOpen, onClose, onSubmit, currentOffer }) {
                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-[#1a1a1a] border border-neutral-800 p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-4">
                                    <p className="text-sm text-neutral-400 mb-4">The buyer's current offer is <span className='font-bold text-white'>${currentOffer.toFixed(2)}</span>. Propose a new price for the exclusive license.</p>
                                </div>

                                <div className="mt-6 space-y-4">
                                    <div>
                                        <label htmlFor="counter-offer" className="block text-sm font-medium text-neutral-300 mb-2">Your Counter-Offer ($)</label>
                                        <input
                                            type="number"
                                            id="counter-offer"
                                            value={offer}
                                    ...
                                    <div>
                                        <label htmlFor="counter-message" className="block text-sm font-medium text-neutral-300 mb-2">Message (Optional)</label>
                                        <textarea
                                            id="counter-message"
                                            rows="4"
                                            value={message}
